        ...
        <>
            <footer>
                <div class="footer-content">
                    <h3>Laboratorio Bioinformática y Aprendizaje Autónomo</h3>
                    <ul class="socials">
                        <li><a href="https://www.facebook.com/espol" target="_blank"><i className="fab fa-facebook"></i></a></li>
                        <li><a href="https://twitter.com/espol" target="_blank"><i className="fab fa-twitter"></i></a></li>
