      ...
      <div id="all-content">
        ...
        <div id="primary-content">
          <div className="contenedor-imagen">
            <img src={teamTurtle} alt="Team Turtle" />
          </div>
            <h2>Welcome to the Laboratory of Bioinformatics and Autonomous Learning (LBA<sup>2</sup>)</h2>
            <article>LBA2 led by Professor Edwin Valarezo Añazco, is dedicated to fundamental and applied research in healthcare, medical, robot, and advanced control fields.</article>
